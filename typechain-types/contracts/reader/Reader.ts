...
export declare namespace Reader {
  ...
  export type MarketInfoStruct = {
    ...
    virtualInventory: Reader.VirtualInventoryStruct;
  ...
  export type MarketInfoStructOutput = [
    ...
    Reader.VirtualInventoryStructOutput,
    boolean
  ] & {
    ...
    virtualInventory: Reader.VirtualInventoryStructOutput;
    isDisabled: boolean;
  };
}
...
export interface ReaderInterface extends utils.Interface {
  functions: {
    ...
    "getPositionPnlUsd(address,(address,address,address,address),((uint256,uint256),(uint256,uint256),(uint256,uint256)),bytes32,uint256,uint256)": FunctionFragment;
