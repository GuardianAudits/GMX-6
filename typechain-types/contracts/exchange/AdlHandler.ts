...
export interface AdlHandlerInterface extends utils.Interface {
  functions: {
    ...
    "executeAdl(address,address,address,bool,uint256,(uint256,address[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],bytes[],address[]))": FunctionFragment;
    "oracle()": FunctionFragment;
    "orderVault()": FunctionFragment;
    "referralStorage()": FunctionFragment;
    "roleStore()": FunctionFragment;
    "swapHandler()": FunctionFragment;
    "updateAdlState(address,bool,(uint256,address[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],bytes[],address[]))": FunctionFragment;
  };
