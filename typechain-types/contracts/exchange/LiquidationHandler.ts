...
export interface LiquidationHandlerInterface extends utils.Interface {
  functions: {
    ...
    "executeLiquidation(address,address,address,bool,(uint256,address[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],uint256[],bytes[],address[]))": FunctionFragment;
